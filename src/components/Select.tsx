...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ref={ref}
        className={cn(
            "flex h-10 w-full items-center justify-between rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm ring-offset-white placeholder:text-neutral-500 disabled:cursor-not-allowed disabled:opacity-50  dark:border-neutral-800 dark:bg-neutral-950 dark:ring-offset-neutral-950 dark:placeholder:text-neutral-400 dark:focus:ring-neutral-300",
            className,
            // Injected Styles
            "border-gray-300 border hover:border-secondary-300 focus:outline-none rounded-lg w-full px-4 mt-2 text-base py-5 "
            // 
        )}
        {...props}
    >
        ...
        <SelectPrimitive.Icon asChild>
            <Icon icon="fluent:chevron-down-16-filled" className="h-4 w-4" />
...
>(({ className, ...props }, ref) => (
    <SelectPrimitive.ScrollUpButton
        ...
        {...props}
    >
        <Icon icon="fluent:chevron-up-16-filled" className="h-4 w-4" />
    ...
    >
        <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
            <SelectPrimitive.ItemIndicator>
                <Icon icon="fluent:checkmark-12-filled" className="h-4 w-4" />
